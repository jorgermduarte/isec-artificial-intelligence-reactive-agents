...
;Each 1 green food , +5 energy
;Each 10 green food , + 2 exp
;Each 1 yellow food , +5 energy
;Each 10 yellow food, + 1 exp
...
to setup-turtles
  ...
  create-basic initial-number-basic
  [
    set shape "star"
  ...
  create-expert initial-number-expert
  [
    set shape "target"
    set energy 100
    setxy random-pxcor random-pycor
  ...
  [
    ...
    [
      ...
      [ifelse [pcolor] of patch-ahead 1 = red and energy < 100 ; trap forward < 100
        [
          die]
        [ifelse [pcolor] of patch-right-and-ahead 90 1 = red and energy >= 100 ; trap right >= 100
          [
            set energy energy - 10 ; change to -10% , idk how
            right 90
            set energy energy - 1
        ...
        [ifelse [pcolor] of patch-ahead 1 = blue and any? expert-on patch-ahead 1 ; shelter and expert forward
          ...
          [ifelse [pcolor] of patch-ahead 1 = blue ; shelter forward
            ...
            [ifelse [pcolor] of patch-right-and-ahead 90 1 = blue and any? expert-on patch-right-and-ahead 1
                      [
...
to moveExpert
  ...
  [
    ...
    [ifelse [pcolor] of patch-left-and-ahead 1 = green
      [
        left 90
        set energy energy - 1
        set energy energy + 10
      ]
      [ifelse [pcolor] of patch-right-and-ahead 1 = green
        [
        right 90
        set energy energy -1
        set energy energy + 10
        ...
        [ifelse [pcolor] of patch-ahead 1 = yellow
          ...
          [ifelse [pcolor] of patch-left-and-ahead 1 = yellow
            [
             left 90
             set energy energy - 1
             set energy energy + 5
